...
### 2.3 选项 B — 保留魔数评分,补样本置信度与归一
> (此处沿用用户语义:用户最终选择"接校准器+统一",对应本文档执行的就是 2.2 的选项 A 路线。保留本节仅作决策留痕。)
...
### 2.5 决策记录
- **决策:接入 router-calibrator 取代裸魔数评分,并统一打分系统(对应 §2.2 路线)。**
- 决策人:用户。
