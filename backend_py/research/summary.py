...
def build_summary_row(
    *,
    ...
    row = {
        ...
        "topWeatherRoute": current.get("topWeatherRoute"),
        "topWeatherScore": current.get("topWeatherScore"),
        "weatherSummary": current.get("weatherSummary"),
        "actionBias": current.get("actionBias"),
        "volatilityState": current.get("volatilityState"),
        "atrPct": current.get("atrPct"),
        "atrPercentile": current.get("atrPercentile"),
        "volatilityMultiple": current.get("volatilityMultiple"),
        "volatilityMultiplePercentile": current.get("volatilityMultiplePercentile"),
        "remainingMomentumAtr": current.get("remainingMomentumAtr"),
        "remainingMomentumState": current.get("remainingMomentumState"),
        "fiveDayAtrDownProbabilityPct": current.get("fiveDayAtrDownProbabilityPct"),
        "fiveDayAtrUpProbabilityPct": current.get("fiveDayAtrUpProbabilityPct"),
        "fiveDayFutureMomentumPositivePct": current.get("fiveDayFutureMomentumPositivePct"),
        ...
        "atr3To21": current.get("atr3To21"),
        "atr8To21": current.get("atr8To21"),
        "middleState": current.get("middleState"),
        "middleDeviationRate": current.get("middleDeviationRate"),
        "middleDeviationAtr": current.get("middleDeviationAtr"),
        ...
        "middleTenDayReturnCloserPct": current.get("middleTenDayReturnCloserPct"),
        "maState": current.get("maState"),
        "maDeviationRate": current.get("maDeviationRate"),
        "maDeviationAtr": current.get("maDeviationAtr"),
        ...
        "maTenDayContinueAwayPct": current.get("maTenDayContinueAwayPct"),
        "trendState": current.get("trendState"),
        "trendScore": current.get("trendScore"),
        "resonanceDirection": current.get("resonanceDirection"),
        "resonanceCount": current.get("resonanceCount"),
        "volumeState": current.get("volumeState"),
        "volumeMultiple": current.get("volumeMultiple"),
        "deviationWeather": final_weather.get("weather"),
        "deviationRiskNote": final_weather.get("riskNote"),
    }
