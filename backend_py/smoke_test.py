...
def main() -> None:
    ...
    assert "backend_py.build_feature_factory" in package_scripts["features"]
    assert "--official" in package_scripts["features"]
    assert "backend_py.build_deviation_rules" in package_scripts["rules:deviations"]
